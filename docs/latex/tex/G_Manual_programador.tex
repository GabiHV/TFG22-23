...
Para realizar la instalación en un sistema Windows es necesario disponer a su vez del WSL (Windows Subsystem Linux) activo y funcionando con una distribución
de Ubuntu.
