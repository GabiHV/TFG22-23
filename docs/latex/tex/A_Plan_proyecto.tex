...
con metodologías ágiles \cite{book:palacio2021}, como las reuniones diarias ``daily'' para atender diferentes cuestiones como cúales son los 
...
del negocio.
Las tareas inciales se correspondían con la fase de comprensión de datos y a su vez con la preparación de estos, 
...
Se plantea la implementación de una matriz de correlación para observar cúales de los atributos seleccionar para el entrenamiento.
...
realizar los modelados, además de dejar el fichero de pre-procesamiento documentado con las explciaciones pertinentes.
...
De esta forma, en el desarrollo se aplicó el métdodo mencionado para la selección de datos del modelo, de modo que se pudiera evitar la situación
anterior.
...
De esta forma, se debe seleccionar una licencia compatible con Apache v2.0 y BSD, siendo la primera la más restrictiva de las licencias, requieriendo la conservación del aviso de derecho
