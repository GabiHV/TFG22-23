...
Durante el desarrollo del \textit{sprint} se modificaron los umbrales empleados en la detección y manejo de valores extremos, para eliminar la mayor
...
De esta forma, en el desarrollo se aplicó el método mencionado para la selección de datos del modelo, de modo que se pudiera evitar la situación
anterior.
...
Por otra parte, se comienza la corrección de los anexos en base a los comentarios de los docentes y se
...
\subsection{Sprint 15 (27/06/2023 - 04/07/2023)}
En la reunión del sprint se acuerda la reducción en contenidos de la presentación del proyecto
para adecuarse al tiempo disponible para la exposición y dejando espacio suficiente para
reproducir el vídeo con la ejecución de los entrenamientos.

Por otra parte, se indica la necesidad de realizar cambios en el resumen de la memoria para 
adecuarlo a la descripción de este y que, de esta forma, no sea una simple introducción 
resumida.

De esta forma, se comienzan las realizaciones de resúmenes para sintetizar el desarrollo 
realizado en el proyecto, además de realizar las correcciones mencionadas en los apartados
descritos.
...
El porcentaje mensual de aporte a la Seguridad Social se calcula como el 0,2\% al Fondo de Garantía Salarial (FOGASA), más el 0,6\%, el 6,7\% de
